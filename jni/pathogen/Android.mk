...
# $(LOCAL_PATH)/../ffmpeg-ffmpeg-android/
# $(LOCAL_PATH)/../avilib/
LOCAL_STATIC_LIBRARIES := libzip libpng cocos_jpeg_static android_native_app_glue libz
# avilib_static
# wavlib_static 
# libzip 
# libGLESv1
#libavcodec libavformat libavutil libc libz libswscale
# avilib_static wavlib_static
...
LOCAL_SRC_FILES := utils.cpp shader.cpp font.cpp file.cpp image.cpp 3dmath.cpp \
					...
					frustum.cpp menu.cpp platform.cpp avilib.cpp wavlib.cpp main.cpp
# avilib.cpp
...
LOCAL_LDLIBS := -ldl -lz -llog -lGLESv2 -landroid -lEGL -lOpenSLES
# -lz
#-lGLESv1_CM
#-lglesv1
