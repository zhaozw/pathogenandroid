...
{
	public static final int FIRST_OBJECT_ID = 3;
	...
	float m_Frustum[][] = new float[6][4];	// This holds the A B C and D values for each side of our frustum.
	...
	void CalculateFrustum(float proj[], float modl[])
	{
		//float   proj[16];
		//float   modl[16];
		float   clip[] = new float[16];	// clipping planes
